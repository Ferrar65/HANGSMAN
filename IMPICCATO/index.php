...
<div class="col-sm">
<h2>Regole Dell'Impiccato:</h2><br>
<p>
  <h4><strong>
    MultiPlayer:
  </h4></strong>
L'impiccato è un gioco dove Uno dei giocatori sceglie segretamente una parola; l'altro deve indovinarla.
L'altro tenta di indovinare la parola dichiarando una lettera a ogni turno. Se la lettera compare nella parola,
il giocatore non perde punti, Invece se non compare perde un punto e compare la linea che tracia l'impicatto, i punti ad ogni partita sono 7, una volta terminati la partita si conclude con la perdita.
</p>
<h4><strong>
  SinglePlayer:
</h4></strong>
Se viene scelta la modalità SinglePlayer la parola viene selezionata in modo randomico da una lista di parole.<ul>
...
visualizzato nella <a href="credits.php">Crediti</a>.</li>
</ul>
</div>
</div>
<br><br><br>
...
<a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">SinglePlayer</a>
